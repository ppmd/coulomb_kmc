...
def time_test_1(N=100, nprop=None, nsample=100):
    ...
    t0 = time.time()
    prop_energy = kmc_fmm.propose(moves=prop)
    t1 = time.time()
...
if __name__ == '__main__':
    ...
    times = []
    for nx in nset:
        ti, ni, ri, tai, nsample2 = time_test_1(N=int(nx), nprop=10)
